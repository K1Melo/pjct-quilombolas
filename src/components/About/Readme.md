...
<template>
    <div class="work-tools">
        ...
        <swiper :effect="'cards'" :pagination="{
            ...
            <swiper-slide>
                <div class="text-tool">
                    <p>Utilizamos o framework Vue.js pela sua baixa curva de aprendizado, com ele suas ferramentas como por exemplo Vuex para gestão de estados e Vue Router para as rotas, além do Vue CLI para criação do projeto.</p>
                </div>
                <div class="name">
                    <h3>Vue.js</h3>
...
<script>
export default {
    // Any additional component logic can be added here
}
</script>
