<template>
    <div class="creation">
        <div class="main">
            <div class="up">
                <button class="card1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 128 128" class="vue">
                        <path fill="none"
                ...
                <button class="card2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="node">
                        <path
            ...
            <div class="down">
                <button class="card3">
                    <img src="../../assets/html&css.svg" class="github" width="50" height="50">
                </button>
                <button class="card4">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24" class="discord">
                        <path
...
.card1 {
    ...
    border: none;
    background: white;
    border-radius: calc(150px + 5vw) 5px 5px 5px;
...
.card2 {
    ...
    border: none;
    background: white;
    border-radius: 5px calc(150px + 5vw) 5px 5px;
    box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;
    transition: .2s ease-in-out;
}
...
.card3 {
    ...
    border: none;
    background: white;
    border-radius: 5px 5px 5px calc(150px + 5vw);
    box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;
    transition: .2s ease-in-out;
}
...
.card4 {
    ...
    border: none;
    background: white;
    border-radius: 5px 5px calc(150px + 5vw) 5px;
    box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;
    transition: .2s ease-in-out;
}
...
.card3:hover {
    cursor: pointer;
    scale: 1.1;
    background: linear-gradient(0.90turn, #969fff, #ff6060);
}
